...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('bakamitai')
        .setDescription('🎵 Dame da ne dame yo 🎵'),
    async execute(interaction) {
        ...
        if (voiceChannel == null) {
            ...
            const resourcePath = path.join(__dirname, '../../resources/audio/BakaMitai.mp3')

            const resourceAudio = createAudioResource(resourcePath)
            ...
            resourceAudio.audio = 0.5;
            player.play(resourceAudio);
